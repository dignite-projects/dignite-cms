...
namespace Dignite.Cms.Migrations
{
    ...
    [Migration("20230910024630_language-rename-to-region")]
    partial class languagerenametoregion
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Dignite.Cms.Entries.Entry", b =>
                {
                    ...
                    b.HasIndex("SectionId", "Region", "Slug");

                    b.HasIndex("SectionId", "CreatorId", "PublishTime", "Status");

                    b.HasIndex("SectionId", "Region", "PublishTime", "Status");
