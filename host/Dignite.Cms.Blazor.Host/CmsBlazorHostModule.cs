...
[DependsOn(
    ...
    typeof(CmsAdminBlazorWebAssemblyModule)
)]
public class CmsBlazorHostModule : AbpModule
{
    ...
    private void ConfigureMenu(ServiceConfigurationContext context)
    {
        ...
        {
            options.MenuContributors.Add(new CmsHostMenuContributor(context.Services.GetConfiguration()));
        });
    }
    ...
    private void ConfigureAutoMapper(ServiceConfigurationContext context)
    {
        ...
        {
            options.AddMaps<CmsBlazorHostModule>();
        });
    }
}
