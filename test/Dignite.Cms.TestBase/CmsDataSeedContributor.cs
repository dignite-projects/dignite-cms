...
public class CmsDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    public CmsDataSeedContributor(IClock clock, ICmsUserRepository cmsUserRepository, ICurrentTenant currentTenant, CmsTestData cmsKitTestData, 
